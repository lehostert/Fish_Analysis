...
### Note this file is missing tolerance values for some species they were added in manually and the final file is know as 
### "//INHS-Bison/ResearchData/Groups/Kaskaskia_CREP/Analysis/Fish/Data/Illinois_fish_traits_complete.csv"
# END #
#############################################
