...
envi <- all %>% 
  select(LINK,	DLINK,	C_ORDER,	DORDER,	WT_Area,	
         WT_GDD,	WT_JUL_MNX,	WT_PREC,	
         C_BR50,	C_BR100,	C_BRG100,	WT_BR50,	WT_BRG100,	WT_BRG100,	
         ...
         BIGRIVER,	DAMDWL,	DAMDW,	DAMUPL,	DAMUP,	MISSI,	POND,	POND_AREA,	PONDDWL,	PONDDWA,	PONDDW,	PONDUPL,	PONDUPA,	PONDDW,	
         SINUOUS,	W_TOTAL_SQM,	W_SLOPE,	WT_SLOPE,	GRADIENT,	prop_local_CRP
         )

envi <- envi %>%  rename(Order = C_ORDER,	Downorder = DORDER,	WT_Area = WT_Area,	WT_GDD = WT_GDD,	WT_JulMin = WT_JUL_MNX,	WT_Precip = WT_PREC,	
                         C_BR50 = C_BR50,	C_BR100 = C_BR100,	C_BRG100 = C_BRG100,	WT_BR50 = WT_BR50,	WT_BR100 = WT_BRG100,	WT_BRG100 = WT_BRG100,	
                         ...
                         Missi = MISSI,	Pond = POND,	Pondarea = POND_AREA,	Ponddn_L = PONDDWL,	Ponddn_S = PONDDWA,	Ponddnst = PONDDW,	Pondup_L = PONDUPL,	
